...
#ifndef FLATBUFFERS_GENERATED_VECTOR3_GEOMETRY_MSGS_H_
#define FLATBUFFERS_GENERATED_VECTOR3_GEOMETRY_MSGS_H_
...
inline const geometry_msgs::Vector3 *GetVector3(const void *buf) {
  return flatbuffers::GetRoot<geometry_msgs::Vector3>(buf);
}

inline const geometry_msgs::Vector3 *GetSizePrefixedVector3(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<geometry_msgs::Vector3>(buf);
}

inline bool VerifyVector3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<geometry_msgs::Vector3>(nullptr);
}

inline bool VerifySizePrefixedVector3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<geometry_msgs::Vector3>(nullptr);
}

inline void FinishVector3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<geometry_msgs::Vector3> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_VECTOR3_GEOMETRY_MSGS_H_
