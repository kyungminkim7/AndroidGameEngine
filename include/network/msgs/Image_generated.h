...
#ifndef FLATBUFFERS_GENERATED_IMAGE_MSGS_H_
#define FLATBUFFERS_GENERATED_IMAGE_MSGS_H_
...
inline const msgs::Image *GetImage(const void *buf) {
  return flatbuffers::GetRoot<msgs::Image>(buf);
}

inline const msgs::Image *GetSizePrefixedImage(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<msgs::Image>(buf);
}

inline bool VerifyImageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<msgs::Image>(nullptr);
}

inline bool VerifySizePrefixedImageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<msgs::Image>(nullptr);
}

inline void FinishImageBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<msgs::Image> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_IMAGE_MSGS_H_
