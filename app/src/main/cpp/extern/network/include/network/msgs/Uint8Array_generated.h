...
#ifndef FLATBUFFERS_GENERATED_UINT8ARRAY_MSGS_H_
#define FLATBUFFERS_GENERATED_UINT8ARRAY_MSGS_H_
...
inline flatbuffers::Offset<Uint8Array> CreateUint8ArrayDirect(
  ...
  return msgs::CreateUint8Array(
      _fbb,
      data__);
}

inline const msgs::Uint8Array *GetUint8Array(const void *buf) {
  return flatbuffers::GetRoot<msgs::Uint8Array>(buf);
}

inline const msgs::Uint8Array *GetSizePrefixedUint8Array(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<msgs::Uint8Array>(buf);
}

inline bool VerifyUint8ArrayBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<msgs::Uint8Array>(nullptr);
}

inline bool VerifySizePrefixedUint8ArrayBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<msgs::Uint8Array>(nullptr);
}

inline void FinishUint8ArrayBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<msgs::Uint8Array> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_UINT8ARRAY_MSGS_H_
